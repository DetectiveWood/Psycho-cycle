    ...
    def __init__(self):
        self.dreams = {
            ...
            'warning_walk': {
                ...
                'descriptions': [
                    'Во время прогулки вам становится не по себе. Тени двигаются сами по себе, а ветер шепчет тревожные слова...',
                    'Вы гуляете по парку, но небо вдруг темнеет. Ветер усиливается, и вы слышите чьи-то шаги за спиной...',
                    'Прогулка по парку превращается в лабиринт. Вы заблудились, из тумана появляются странные силуэты...'
                ],
            ...
            'warning_cinema': {
                ...
                'location': 'Кинотеатр',
                'descriptions': [
                    'Кинотеатр во сне пуст. На экране показывают ваши худшие воспоминания, и вы не можете отвести взгляд...',
                    'Вы смотрите фильм, но внезапно экран становится чёрным. Все двери заперты, а свет гаснет...',
            ...
            'warning_gym': {
                ...
                'location': 'Спортзал',
                'descriptions': [
                    'В спортзале все тренажёры двигаются сами. Вы пытаетесь сбежать, но беговая дорожка ускоряется, не давая остановиться...',
                    'Во сне вы в спортзале, но не можете двигаться. Ваше тело не слушается, а зеркала показывают искажённые отражения...',
                    'Сон показывает пустой спортзал ночью. Слышны странные звуки из раздевалок, свет мигает...'
                ],
            ...
            'motivating_exercise': {
                ...
                'activity': 'Спорт',
                'descriptions': [
                    'Во сне вы бежите - это легко и приятно. Ваше тело полно энергии, вы чувствуете себя сильным...',
